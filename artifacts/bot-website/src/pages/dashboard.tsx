  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-3xl font-bold tracking-tight mb-2">Sunucu Seç</h1>
          <p className="text-muted-foreground">Yönetmek istediğin sunucuyu seç ve BasurAi ayarlarını buradan düzenle.</p>
        </div>
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center border-dashed bg-muted/5">
            ...
            <p className="text-muted-foreground mb-6 max-w-md mx-auto">
              BasurAi henüz hiçbir sunucunda yok. Botu sunucuna ekle ve burada yönetmeye başla.
            </p>
            <a 
              href="https://discord.com/oauth2/authorize?client_id=1487520589722685551&permissions=8&scope=bot%20applications.commands"
              target="_blank"
              rel="noreferrer"
              data-testid="button-add-to-server-empty"
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <CardDescription>{guild.messageCount.toLocaleString("tr-TR")} mesaj</CardDescription>
                      </div>
                    </div>
                  </CardHeader>
                </Card>
